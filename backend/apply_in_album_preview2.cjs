...
code = code.replace("{visiblePages.map((pageIndex) => {", () => inAlbumPreviewCode + "\n            {visiblePages.map((pageIndex) => {");

fs.writeFileSync('C:/Users/Jeffry/Desktop/Carpetazo.cl/Publicar mis cartas/frontend/src/components/AlbumView.jsx', code);
console.log("Successfully safely applied the in-album preview spread via exact string match");
