...
const replacement = `          <div
            className="relative mt-2 md:mt-4 touch-pan-y"
            style={{ 
              perspective: '3500px', 
              aspectRatio: '7.5/10.5',
              height: isDesktop ? 'min(70vh, 650px)' : 'auto',
...
console.log("Applied height constraints to prevent vertical scrolling on Desktop");
