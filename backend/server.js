...
// --- MYL SORTER API ---
app.get('/api/admin/myl-sorter', async (req, res) => {
  try {
    const pbGroups = [
      'Espada Sagrada', 'Cruzadas', 'Helenica', 'Imperio', 
      'Hijos de Daana', 'Tierras Altas', 'Dominios de RA', 'Encrucijada', 
      'Dracula Inferno', 'ColmillosPB', 'Leyendas1PB', 'Leyendas3PB'
    ];
...
app.post('/api/admin/myl-sorter', async (req, res) => {
  try {
    const { cardId, targetGroupName } = req.body;
