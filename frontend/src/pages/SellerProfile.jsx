                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-8">
                  {folders.map((folder) => (
                    <Link to={`/c/${folder.id}`} key={folder.id} className="@container relative w-full aspect-[32/37] max-w-[320px] mx-auto flex flex-col cursor-pointer group hover:-translate-y-2 transition-transform duration-300">
                      ...
                      <div className="absolute inset-0 bg-[url('/images/carpeta_v4.webp')] bg-[length:100%_100%] bg-no-repeat drop-shadow-lg group-hover:drop-shadow-2xl transition-all" style={{ filter: getFolderFilter(folder.color) }}></div>
