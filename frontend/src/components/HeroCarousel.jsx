          ...
          <div className="z-10 relative flex justify-center items-center h-[70px] w-full">
            <div className="absolute flex justify-center items-center scale-[0.45] w-full">
              <div className="relative w-48 h-36 transform -rotate-12 z-10 opacity-90 -mr-16">
                <div className="absolute inset-0 bg-[url('/images/carpeta_v4.webp')] bg-[length:100%_100%] bg-no-repeat drop-shadow-xl" style={{ filter: getFolderFilter('black') }}></div>
                <img src="/images/logos/yugioh.webp" className="absolute bottom-6 right-8 h-16 object-contain drop-shadow-[0_0_8px_rgba(255,255,255,0.8)] z-10" alt="Yugioh" />
              </div>
              <div className="relative w-56 h-40 transform rotate-6 z-20 flex items-center justify-center">
                <div className="absolute inset-0 bg-[url('/images/carpeta_v4.webp')] bg-[length:100%_100%] bg-no-repeat drop-shadow-2xl" style={{ filter: 'hue-rotate(30deg) brightness(1.1) saturate(1.2)' }}></div>
                <img src="/images/logos/pokemon.webp" className="absolute bottom-8 right-10 h-10 object-contain drop-shadow-[0_0_8px_rgba(255,255,255,0.8)] z-10" alt="Pokemon" />
              </div>
              <div className="relative w-48 h-36 transform rotate-[15deg] z-10 opacity-90 -ml-16">
                <div className="absolute inset-0 bg-[url('/images/carpeta_v4.webp')] bg-[length:100%_100%] bg-no-repeat drop-shadow-xl" style={{ filter: getFolderFilter('blue') }}></div>
                <img src="/images/logos/magic.webp" className="absolute bottom-6 left-8 h-14 object-contain drop-shadow-[0_0_8px_rgba(255,255,255,0.8)] z-10" alt="Magic" />
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-row items-center justify-between p-8 h-full w-full gap-4">
          ...
          <div className="w-1/2 relative h-[220px] flex items-center justify-center">
            ...
            <div className="relative w-56 h-40 transform rotate-12 hover:rotate-6 hover:scale-105 duration-300 z-20 flex items-center justify-center">
              <div className="absolute inset-0 bg-[url('/images/carpeta_v4.webp')] bg-[length:100%_100%] bg-no-repeat drop-shadow-[0_20px_30px_rgba(0,0,0,0.4)]" style={{ filter: 'hue-rotate(30deg) brightness(1.1) saturate(1.2)' }}></div>
              <img src="/images/logos/pokemon.webp" className="absolute bottom-8 right-10 h-10 object-contain drop-shadow-[0_0_8px_rgba(255,255,255,0.8)] z-10" alt="Pokemon" />
            </div>
